...
public class AdminServerDiscoveryAutoConfiguration {
	...
	private static class KubernetesDiscoveryClientCondition extends AnyNestedCondition {
		...
		@ConditionalOnBean(
				type = "org.springframework.cloud.kubernetes.client.discovery.KubernetesClientInformerDiscoveryClient")
		static class OfficialKubernetesCondition {

		}

		@ConditionalOnBean(type = "org.springframework.cloud.kubernetes.fabric8.discovery.Fabric8DiscoveryClient")
