...
public class InstanceEventMixinTest {
	...
	class InstanceEventTests {
		...
		@Test
		void verifyDeserializeOfInstanceDeregisteredEvent() throws JacksonException, JSONException {
		...
		@Test
		void verifyDeserializeOfInstanceEndpointsDetectedEvent() throws JacksonException, JSONException {
			String json = new JSONObject().put("instance", "test123")
				.put("timestamp", 1587751031.000000000)
		...
		@Test
		void verifyDeserializeOfInstanceInfoChangedEvent() throws JacksonException, JSONException {
			String json = new JSONObject().put("instance", "test123")
				.put("timestamp", 1587751031.000000000)
		...
		@Test
		void verifyDeserializeOfInstanceRegisteredEvent() throws JacksonException, JSONException {
			String json = new JSONObject().put("instance", "test123")
				.put("timestamp", 1587751031.000000000)
				.put("type", "REGISTERED")
				.put("registration",
		...
		@Test
		void verifyDeserializeOfInstanceRegistrationUpdatedEvent() throws JacksonException, JSONException {
			String json = new JSONObject().put("instance", "test123")
				.put("timestamp", 1587751031.000000000)
		...
		@Test
		void verifyDeserializeOfInstanceStatusChangedEvent() throws JacksonException, JSONException {
			String json = new JSONObject().put("instance", "test123")
				.put("timestamp", 1587751031.000000000)
