...
public class ServerRuntimeHints implements RuntimeHintsRegistrar {
	...
	private static void registerReflectionHints(org.springframework.aot.hint.RuntimeHints hints) {
		...
		hints.reflection()
			...
			.registerTypes(TypeReference.listOf(JDKMiscSerializers.AtomicBooleanSerializer.class,
					JDKMiscSerializers.AtomicIntegerSerializer.class, JDKMiscSerializers.AtomicLongSerializer.class),
